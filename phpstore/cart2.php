					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								<tr class="table_head">
									<th style="text-align: center" class="column-1">Name</th>
									<th style="text-align: center" class="column-2">Price</th>
									<th style="text-align: center" class="column-3">Quantity</th>
									<th style="text-align: center" class="column-4">Action</th>
								...
								<tr class="table_row">
									...
									<td style="text-align: left" class="column-1"><?php echo $value['item_name']?></td>
									<td style="text-align: center " class="column-2">₹<?php echo $value['item_price']?></td>
									<td class="column-3">
									...
									<button class="btn btn-sm btn-outline-danger" name="update">Update</button>
											<input type="hidden" name="item_name" value="<?php echo $value['item_name']?>"><hr>
											<div class="">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								<p class="stext-111 cl6 p-t-2">
									We will deliver to any required location.
								</p>
