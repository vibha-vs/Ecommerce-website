	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				include ("partials/connect.php");
				$cat_id=$_GET['cat_id'];
				$sql="SELECT * FROM products WHERE category_id='$cat_id' LIMIT 4";
				$results=$connect->query($sql);
			...
			<?php
				...
				$cat_id=$_GET['cat_id'];
				if($cat_id==1){?>
				<a href="women.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
				<?php }
				else if($cat_id==2){?>
				<a href="men.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
				<?php }
				else if($cat_id==3){?>
				<a href="shoes.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
				<?php }
				else if($cat_id==4){?>
				<a href="accessories.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
				<?php }?>
